...
const PartyCTA = () => {
    return (
        <button className="flex flex-col mx-auto w-5/6 p-4 text-center bg-neutral-300/25 border-dashed border-4 border-neutral-300 rounded-lg shadow sm:p-8 hover:bg-neutral-500/25 hover:border-neutral-500 click:bg-red" onClick="">
